...
Background 
===
We first go through a bit of R programming that you have not seen. This will not be a complete review, so please be sure to go through this on 
...
We could "block" data points deterministically
based upon their attribute values and place them into bins. 
...
1. We'll learn one way that we can go about doing this --- locality senstive hashing. 
