...
\smallskip
\begin{center}
\includegraphics[width=0.5\textwidth]{chooseex1a.pdf}
\includegraphics[width=0.5\textwidth]{chooseex1b.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{chooseex1a.pdf}
\includegraphics[width=0.5\textwidth]{chooseex3.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{chooseex1a.pdf}
\includegraphics[width=0.5\textwidth]{chooseex4.pdf}
\end{center}
\vspace{-8pt}
...
Running example: $n=250$, $p=2$, $K=1,\ldots 10$
\begin{center}
\includegraphics[width=0.5\textwidth]{chooseex5a.pdf}
\includegraphics[width=0.5\textwidth]{chooseex5b.pdf}
\end{center}
